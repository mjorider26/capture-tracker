...
console.log("CLOUDFLARE RUNTIME VERIFIED: App Router build configuration, route handlers, Server Actions, Better Auth, Prisma/Neon Node compatibility, no-store/noindex, health endpoints, and server-secret boundaries passed static verification.");
