...
const expectedTables = new Set([
  ...
  "PayrollRun",
  "PayrollBankMatch",
  "ReasonableCompWorkpaper",
  "FixedAsset",
  "MonthEndClose",
  "OwnerDistribution",
  "ShareholderBasisWorkpaper",
  "ShareholderBasisAdjustment",
  "ShareholderDebtInstrument",
  "DistributionReadinessSnapshot",
  "AccountingPolicy",
  "AccountingPolicyVersion",
  "AccountingPolicyApplication",
  "ShareholderBenefitWorkpaper",
