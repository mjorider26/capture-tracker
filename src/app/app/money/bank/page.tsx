...
export default async function BankConnectionsPage() {
  ...
  return <AppShell mode="app" destination="money" businessName={context.business.displayName}><BankConnections {...workspace} canManage={context.membership.role === "OWNER"} mapAction={mapBankAccountAction}/></AppShell>;
}
