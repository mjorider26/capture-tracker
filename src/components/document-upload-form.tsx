...
export function DocumentUploadForm() {
  ...
  return (
    <section id="document-upload" className="ui-card scroll-mt-6 p-5 sm:p-6">
      <h2 className="text-lg font-bold">Upload a private document</h2>
      <p className="mt-1 text-sm text-text-muted">PDF, JPEG, or PNG only · 10 MiB maximum. Files are strictly validated and stored in private object storage. Malware scanning is deferred for this private single-owner pilot.</p>
